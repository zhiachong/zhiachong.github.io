                ...
                <div id="content">
                    ...
                    {/if}
                       <article class="box-icon clearfix">
                        ...
                        <input type=hidden name="success_url" value="{$settings.site_url}/processing_status.php?process=yes">
                        <input type=hidden name="fail_url" value="{$settings.site_url}/processing_status.php?process=no">
                        <input type=hidden name="calback_url" value="{$settings.site_url}/processing_alertpay.php">
