...
{if $ec}
<form method=post name="exchange_form" action="account_exchange.php">
...
<tr>
 ...
 <td><img src="images/pay/{$ec[ec].ec}.gif" align=absmiddle height=21> {$ec[ec].ec_name} :</td>
...
<tr> <td align=center class=calendartablebg>From / To</td>
{section name=from loop=$exchange}
 <td align=center class=calendartablebg><img src="images/pay/{$exchange[from].from}.gif" height=21></td>
{/section}
</tr>
{section name=from loop=$exchange}
<tr>
 <td align=center class=calendartablebg id="e{$exchange[from].from}_t"><img src="images/pay/{$exchange[from].from}.gif" height=21></td>
 {section name=to loop=$exchange[from].tos}
