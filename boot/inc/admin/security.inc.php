...
/***********************************************************************/
  ...
  if ($frm['say'] == 'done')
  {
    echo '<b style="color:green">Changes have been successfully updated.</b><br><br>';
  }
  ...
  echo '<b>Advanced login security settings:</b><br><br>
...
';
  ...
  if (0 < sizeof ($dirs))
  {
    echo '<b>Security note:</b><br><br>Please upload the .htaccess file to the following folders:<br>';
    for ($i = 0; $i < sizeof ($dirs); ++$i)
    {
      echo '<li>' . $dirs[$i] . '</li>';
    }

    echo 'You can find the .htaccess files in the latest archive with the HYIPManagerScript.com <hr><br><br><br>';
  }
...
';
    ...
    echo '<input type=submit class=sbmt value="Encode mysql data and other settings."><br>It will prevent from hacking attempts when they access mysql directly. Even if a hacker knows your ftp data it will be impossible to change any settings.<br><span style="color: red">This action cannot be undone</span>';
  }
  else
  {
