...
function checkform() {
  if (document.formb.to.selectedIndex == 0) {
    ...
    return confirm("Are you sure you want to send the $"+document.formb.amount.value + " penalty to "+u[document.formb.to.selectedIndex]+" users = $"+document.formb.amount.value*u[document.formb.to.selectedIndex]);
  }
  return true;
}
</script>
...
<tr>
 <td>Amount (US$):</td>
 <td><input type=text name=amount value="100.00" class=inpts size=15 style="text-align: right;"></td>
</tr>
<tr>
 <td>E-currency:</td>
 <td>
...
<tr>
 ...
 <td>Description:</td>
 <td><input type=text name=description value="Enter the penalty description here." class=inpts size=30></td>
</tr><tr>
 <td>&nbsp;</td>
