...
';
  foreach ($exchange_systems as $id => $data)
  {
    if (!($data['status'] != 1))
    {
      echo '<img src=images/pay/' . $id . '.gif height=21> ';
...
<tr>
 ...
 <td align=right><small>$' . number_format ($in[$id]['today'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($out[$id]['today'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($in[$id]['week'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($out[$id]['week'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($in[$id]['month'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($out[$id]['month'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($in[$id]['year'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($out[$id]['year'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($in[$id]['total'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($out[$id]['total'], 2) . '</small></td>
</tr><tr>
 <th colspan=2 ><small>$' . number_format ($in[$id]['today'] - $out[$id]['today'], 2) . '</small></th>
 <th colspan=2 ><small>$' . number_format ($in[$id]['week'] - $out[$id]['week'], 2) . '</small></th>
 <th colspan=2 ><small>$' . number_format ($in[$id]['month'] - $out[$id]['month'], 2) . '</small></th>
 <th colspan=2 ><small>$' . number_format ($in[$id]['year'] - $out[$id]['year'], 2) . '</small></th>
 <th colspan=2 ><small>$' . number_format ($in[$id]['total'] - $out[$id]['total'], 2) . '</small></th>
</tr>
...
<tr>
 ...
 <td align=right><small>$' . number_format ($in['total']['today'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($out['total']['today'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($in['total']['week'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($out['total']['week'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($in['total']['month'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($out['total']['month'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($in['total']['year'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($out['total']['year'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($in['total']['total'], 2) . '</small></td>
 <td align=right><small>$' . number_format ($out['total']['total'], 2) . '</small></td>
</tr>
<tr>
 <th colspan=2 ><small>$' . number_format ($in['total']['today'] - $out['total']['today'], 2) . '</small></th>
 <th colspan=2 ><small>$' . number_format ($in['total']['week'] - $out['total']['week'], 2) . '</small></th>
 <th colspan=2 ><small>$' . number_format ($in['total']['month'] - $out['total']['month'], 2) . '</small></th>
 <th colspan=2 ><small>$' . number_format ($in['total']['year'] - $out['total']['year'], 2) . '</small></th>
 <th colspan=2 ><small>$' . number_format ($in['total']['total'] - $out['total']['total'], 2) . '</small></th>
</tr>                                 
</table>
<br><br>
';
...
<li>Suspended users. These users can login to the members area but will not receive 
  any earnings.</li>
...
<br>
\'Total member\'s balance\' shows you how many funds can users withdraw from the system. 
...
<br>
\'Total withdrawals\' shows you how many funds have you withdrawn to users\' e-gold 
accounts. <br>
<br>
