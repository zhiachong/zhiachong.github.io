...
<tr>
 <td colspan=7 align=right><small>
...
<br>
The top left search form helps you to search a user by the nickname or e-mail. 
...
Actions:<br>
Change status: select a new status in the \'Status\' row and click the \'Modify\' 
button;<br>
...
Add a new Member: click on the "Add a new member" button. You\'ll see the form 
