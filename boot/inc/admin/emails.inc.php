...
/***********************************************************************/
  ...
  if ($settings['demomode'] == 1)
  {
    if ($frm['type'] != '')
    {
      ...
      echo '<b>Demo version restriction!</b><br>You cannot change change e-mail templates! ';
      echo end_info_table ();
    }
  }
...
*Password will be replased with ***** if you use double opt-in confirmation for user registration.
';
  }
...
#site_url#/?a=confirm_registration&c=#confirm_string#<br><br>
