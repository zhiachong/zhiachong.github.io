...
function checkref(a) {
  ...
  document.refform.elements["ref_percent["+a+"]"].disabled = !document.refform.elements["active["+a+"]"].checked;
...
<script language=javascript>checkref(';
    echo $num;
    echo ');</script>
';
    ++$num;
