...
/***********************************************************************/
  ...
  if ($id < 3)
  {
    if ($settings['demomode'] == 1)
    {
      ...
      echo '<b>Demo version restriction!</b><br>You cannot edit this package. You should create a new package for edition. ';
      echo end_info_table ();
    }
  }
...
<br><br><br>
 ...
 <td>
	<select name=hperiod class=inpts onchange="CheckCompound();CalculateProfit();InitCalendar();">
		<option value="d" ';
 ...
 <td>
	<select name=hstatus class=inpts>
		<option value=\'on\' ';
 ...
 <td><input type=input name=withdraw_principal_duration_max value="';
  ...
  echo '" class=inpts> days<br><small>set 0 to skip limitation</small></td>
</tr><tr>
...
';
 ...
 <td colspan=2><input type=checkbox name=parentch value=1 ';
    ...
    echo '> <a href="javascript:alert(\'Administrator can select a \\\'parent\\\' package. Then users should deposit to parent package before depositing to this one.\')" class=hlp>Allow depositing only after the user have deposited to the following package:</a> <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<select name=parent class=inpts><option value=0>Select';
