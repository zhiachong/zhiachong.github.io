...
<tr>
      <td width=150><a href="javascript:alert(\'Enter your package name here.\')" class=hlp>Package 
        Name</a></td>
 <td><input type=text name=hname class=inpts size=30 value="New Package"></td>
      ...
      <td><a href="javascript:alert(\'Specify your package duration here.\\nFor example 30 days, 365 days, or no limit.\')" class=hlp>Package 
        Duration</a></td>
 <td>
	<input type=text name=hq_days class=inpts size=5 style="text-align:right" value="365"> in days
...
<tr>
 ...
 <td align=center><input type=text name="rate_min_amount[0]" value="10" class=inpts size=10 style="text-align:right"></td>
 ...
 <td align=center>2. <input type=checkbox name="rate_amount_active[1]" onclick="checkrates(1)" value=1 checked></td>
 ...
 <td align=center><input type=text name="rate_percent[1]" value="3.3" class=inpts size=10 style="text-align:right"></td>
</tr><tr>
 ...
 <td align=center><input type=text name="rate_min_amount[2]" value="1001" class=inpts size=10 style="text-align:right"></td>
 ...
 <td align=center><input type=text name="rate_amount_name[3]" value="Plan 4" class=inpts size=10></td>
 ...
 <td align=center><input type=text name="rate_percent[3]" value="3.5" class=inpts size=10 style="text-align:right"></td>
</tr><tr>
 ...
 <td align=center><input type=text name="rate_max_amount[4]" value="" class=inpts size=10 style="text-align:right"></td>
...
<br><br><br>
 ...
 <td><select name=hperiod class=inpts onchange="CheckCompound();CalculateProfit();InitCalendar();">
 ...
 <td><select name=hstatus class=inpts>
 ...
 <td>min: <input type=input name=compound_min_deposit value="0" class=inpts size=6> max: <input type=input name=compound_max_deposit value="0" class=inpts size=6></td>
</tr><tr>
 <td><small>set 0 as max to skip limitation</small></td>
</tr><tr>
 ...
 <td>min: <input type=input name=compound_min_percent value="0" class=inpts size=6> max: <input type=input name=compound_max_percent value="100" class=inpts size=6></td>
</tr><tr>
 <td> &nbsp; <input type=radio name=compound_percents_type value=1 onclick="checkd1()">
        Compounding percent solid values:<br> &nbsp;  &nbsp;  &nbsp;  &nbsp;<small>comma separated (ex: 0,30,50,70,100)</small></td>
 <td><input type=input name=compound_percents value="0,30,50,70,100" class=inpts></td>
</tr><tr>
 <td colspan=2><input type=checkbox name=withdraw_principal value=1 onclick="checkc()"><a href="javascript:alert(\'You can allow users to return principal to user account and withdraw it. You can define a fee for this transaction and a minimal deposit duration.\')" class=hlp>
 ...
 <td><input type=input name=withdraw_principal_duration value="20" class=inpts> days</td>
      ...
      <td> &nbsp; Enter the maximal deposit withdrawal duration:</td>
 <td><input type=input name=withdraw_principal_duration_max value="0" class=inpts> days<br><small>set 0 to skip limitation</small></td>
</tr><tr>
...
';
 ...
 <td colspan=2><input type=checkbox name=parentch value=1 ';
    ...
    echo '>
        ...
        <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<select name=parent class=inpts><option value=0>Select
	';
...
';
  ...
  echo '</table><br><script language=javascript>
...
function CheckDailyPlan() {
  if (document.nform.hperiod.selectedIndex == 0) {
    ...
    document.nform.work_week.disabled = true;
  }
}
function checkb(flag) {
  ...
  if (document.nform.hq_days_nolimit.checked == true) {
    ...
    if (document.nform.hperiod.selectedIndex == i) {
       document.nform.hperiod.selectedIndex = 0;
    }
...
function checkc()
{
  document.nform.withdraw_principal_percent.disabled = (document.nform.withdraw_principal.checked) ? false : true;
...
function checkd()
{
  document.nform.compound_min_deposit.disabled = (document.nform.use_compound.checked) ? false : true;
...
function checkd1()
{
  ...
  {
    if (document.nform.compound_percents_type[0].checked)
    {
...
function checkrates(a, flag) {
  ...
  document.nform.elements["rate_max_amount["+a+"]"].disabled = !document.nform.elements["rate_amount_active["+a+"]"].checked;
...
Fill all 5 plans, click \'save\' button, find this package in a package list and 
