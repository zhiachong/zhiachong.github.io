...
function checkform() {
  if (document.formb.to.selectedIndex == 0) {
    ...
    return confirm("Are you sure you want to send $"+document.formb.amount.value + " to "+u[document.formb.to.selectedIndex]+" users = $"+document.formb.amount.value*u[document.formb.to.selectedIndex]);
  }
  return true;
}
</script>
...
<tr>
 ...
 <td>Description:</td>
 <td><input type=text name=description value="Enter the bonus description here." class=inpts size=30></td>
</tr><tr>
