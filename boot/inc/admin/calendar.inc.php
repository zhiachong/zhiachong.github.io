...
/***********************************************************************/
  ...
  echo '<br><br><b>Estimate users earnings:</b><br><br><script>
...
var paymentperiod = \'d\'; // \'d\' - daily, \'w\' - weekly, \'bw\' - beweekly, \'m\' - monthly, \'y\' - yearly
var maxdays = 0;
var returnprofit = 0;
var compound = 0;
...
function UpdateRates()
{
  ...
  for (i = 0; i < 20; i++)
  {
    if (document.nform.elements["rate_amount_active["+i+"]"])
    {
      ...
      {
        percents[j] = new Array(document.nform.elements["rate_min_amount["+i+"]"].value, document.nform.elements["rate_max_amount["+i+"]"].value, document.nform.elements["rate_percent["+i+"]"].value);
        j++;
      }
    }
  }
  ...
  if (document.nform.hq_days_nolimit.checked)
  {
    maxdays = 0;
  }
...
<table cellspacing=1 cellpadding=2 border=0>
  <tr>
   ...
   <td bgcolor="#ff8d00" width=20>Mon</td>
...
<tr>
  <td>Periods:</td><td><b><span id="days">N/A</span></b></td>
</tr>
<tr>
